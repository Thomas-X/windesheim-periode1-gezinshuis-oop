...
use DependencyInjectionContainer\controllers\NotFound;
    ...
    public function checkWhichControllerToRun()
    {
        ...
        foreach ($this->routes as $route) {
            ...
            if ($path == $route['path']) {
                ...
                $controller = 'DependencyInjectionContainer' . '\\' . 'controllers' . '\\' . $controllerAndMethod[0];
