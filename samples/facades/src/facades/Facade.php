...
class Facade
{
    ...
    // this is called when a static method is undefined on a Class
    ...
    protected static function resolveFacadeInstance($name)
    {
        ...
        // by getting an instance from the DI container we can use that to call the method that was undefined
